...
<head>
  ...
  <title>Register Page | Neetgurumantra</title>
...
<body class="cyan">
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form action="{{ URL::to('verifyotp') }}" class="login-form" method="post">
        {{ csrf_field() }}
        <div class="row">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="password" type="password" name="otp">
            <label for="OTP">OTP</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
            <button type="submit" class="btn waves-effect waves-light col s12">Verify OTP</a>
          </div>
          <div class="input-field col s12">
