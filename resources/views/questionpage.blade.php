    ...
    <div class="testTool_sideBar testTool_sideBar-tillBottom js-sidebar">
      <div class="goalsList mt-15 testTool_goalList js-goals-list pl-30">
        ...
        <div class="pr-30">
          ...
          <div v-for="question in questions" class="goalsList_goal goalsList_goal-small goalsList_goal-animate js-goal" data-goal_id="63829" data-progress="0">
            <div class="goalsList_goal_num goalsList_goal_num-small">@{{ question.ques_id }}</div>
            <div class="goalsList_goal_content goalsList_goal_content-small">
              <div class="goalsList_goal_title goalsList_goal_title-small">Question @{{ question.s_no }}</div>
    ...
    <div>
      <div class="testTool_topBar">
        <div class="testTool_topBar_container cf">
          ...
          <button class="testTool_topBar_stateBtn -strk js-btn-finish-assessment difficulty-btn">@{{ basic.type }}</button>
          <button class="testTool_topBar_stateBtn -strk js-btn-finish-assessment difficulty-btn">IMPORTANT</button>
          <h1 class="testTool_topBar_title">@{{ basic.chap_name }}</h1>
        </div>
      </div>
    </div>
    <div v-for="question in questions">
    <div class="testTool_contentArea js-content-area" v-show="question.s_no === questionIndex">
      <div class="testTool_quesWrapper pv-60 js-ques-wrapper">
            ...
            <div class="ques_content">
              <form method="post" class="js-question-form">
                <div class="ques_header cf">
                  ...
                  <div class="ques_header_id">@{{{ question.ques_id }}}</div>
                </div>
                ...
                <div>
                  ...
                  v-bind:class="{ 'is-selected': question_attempt.ans1 }"
                  ...
                  <div class="ques_option is-clickable apply-mathjax js-ques-list-option-item"
                    v-bind:class="{ 'is-selected': question_attempt.ans2 }"
                  ...
                  <div class="ques_option is-clickable apply-mathjax js-ques-list-option-item"
                    v-bind:class="{ 'is-selected': question_attempt.ans3, 'is-correct': correct('3') }"
                  ...
                  <div class="ques_option is-clickable apply-mathjax js-ques-list-option-item"
                    v-bind:class="{ 'is-selected': question_attempt.ans4 }"
                    ...
                    <input type="checkbox" class="hide" name="choices" value="825133">
                    <div class="clr"></div>
                    <div class="solution_text_container js-solution-text" v-show="question.user_input != NULL">
                        <div class="solution_heading">Solution</div>
                        <div class="js-solution-content">
                          <div class="testTool_qSolution_text solution_text">@{{{ question.ques_sol }}}</div>
                        </div>
                      </div>
                  </div>
                </div>
        ...
        <button style="display: none;">Test</button><br><button type="button" class="btn" style="display: none; margin-top: 5px; padding: 10px 30px;">NEXT</button></div>
    </div>
    </div>
...
new Vue({
  ...
  data: {
    ...
    question_attempt: {'ans1':'', 'ans2':'', 'ans3':'', 'ans4':''}
  },
  created: function(){
          this.$http.get('/questions').then((response) => {
            this.$set('questions', response.data.data);
            this.$set('basic', response.data.basic);
  ...
  methods: {
    attempt: function(id) {
      console.log("asdas");
      this.question_attempt = {'ans1':'', 'ans2':'', 'ans3':'', 'ans4':''};
      if(id==='1'){
        this.question_attempt.ans1 = true;
        //console.log(this.question_attempt);
      }
      else if(id==='2'){
        this.question_attempt.ans2 = true;
      }
      else if(id==='3'){
        this.question_attempt.ans3 = true;
      }
      else if(id==='4'){
        this.question_attempt.ans4 = true;
      }

    },
    correct: function(id) {
      //console(this.question.user_input);
      if(null===null){
        return true;
      }else if(null===id){
        return true;
