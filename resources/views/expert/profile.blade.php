                          ...
                          <div class="col-lg-12">
                            <form role=role>
                              <div class="form-group">
                                ...
                                <input class="form-control" value="{{ $user->first_name }}" disabled="disabled">
                              </div>
                              <div class="form-group">
                                <label>Last Name</label>
                                <input class="form-control" value="{{ $user->last_name }}" disabled="disabled">
                              </div>
                              <div class="form-group">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form role="form" method="get" action="{{ URL::to('expert/changepwd') }}" >
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
