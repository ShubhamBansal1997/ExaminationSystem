...
<head>
    ...
    <title>Neetgurumantra-Expert Section</title>
...
<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Neetgurumantra - Expert Section</a>
            </div>
            <form  role="form" method="get" action="{{ URL::to('expert/logout') }}" >
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="{{ URL::to('/expert/logout')}}"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ URL::to('/expert/home') }}"><i class="fa fa-dashboard fa-fw"></i>Profile</a>
                        </li>
<!--                        
                       ...
                       <!--  <li>
                            <a href="{{ URL::to('expert/profile') }}"><i class="fa fa-tasks fa-fw"></i>Profile<span class="fa arrow"></span></a>
                            
                            <!-- /.nav-second-level
                        </li>
                        -->
                        <li>
                            <a href="{{ URL::to('expert/guidance') }}"><i class="fa fa-tasks fa-fw"></i>All guidance sessions<span class="fa arrow"></span></a>
