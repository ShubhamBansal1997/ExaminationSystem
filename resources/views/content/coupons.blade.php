                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           ...
                           <!--    <div class="col-lg-3">
                              ...
                              <div class="col-lg-3">
                                <b>(  6 %  ) for Package</b><!-- {{ \App\Coupon_Activity::where('user_email',$user->email)->where('activity_status','UNPAID')->sum('admin_share') }} -->
                              </div>
                              <div class="col-lg-3">
                                <b>(  6 %  ) for Guidance Session</b><!-- {{ \App\Coupon_Activity::where('user_email',$user->email)->sum('admin_share') }}
                              </div> - -->
                            </div>
                            <!-- Add Coupon Modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form method="post" id="addcouponform">
                                            ...
                                            <div class="form-group">
                                                <label>His/her Benefit Percentage</label>
                                                <input class="form-control" name="coupon_number" value="10%" disabled="disabled">
                                            </div>
