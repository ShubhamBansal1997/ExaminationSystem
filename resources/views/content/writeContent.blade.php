            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                     ...
                     <h3>   Previledges given for: </h3>
                      {{$user->section}}
                     <?php $section = explode(",",$user->section);?>
                      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form role="form" method="get" action="{{ URL::to('content/changePWD') }}" >
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="form-group">
