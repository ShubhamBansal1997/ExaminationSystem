...
<head>
    ...
    <title>Neetgurumantra-Content Writter</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Please Sign In(Content Writter Login)</h3>
                    ...
                    <div class="panel-body">
                        <form role="form" method="post" action="{{ URL::to('content/login') }}">
                            <fieldset>
                                {!! csrf_field() !!}
