                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr  class="odd gradeX">
                                      ...
                                      <td>
                                      <a href=" {{ URL::to('content/editques') }}/{{ $question->ques_id }}/{{ $sub_id }}/{{ $std }} "><i class="fa fa-edit"></i></a>
                                      ...
                                      <a target="_blank" href="{{ URL::to('content/view_look') }}/{{ $question->ques_id }} "><i class="fa fa-edit"></i></a>
                                      <a target="_blank" href="{{ URL::to('content/view_look1') }}/{{ $question->ques_id }} "><i class="fa fa-edit"></i></a>
                                      <a target="_blank" href="{{ URL::to('content/view_look2') }}/{{ $question->ques_id }} "><i class="fa fa-edit"></i></a>
