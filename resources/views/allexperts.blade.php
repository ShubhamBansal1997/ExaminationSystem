...
<html lang="en" class="h-full">
    ...
    <nav class="navbar navbar-toggleable-md navbar-light" style="background: #fff;">
        <div class="container">
            ...
            <a class="navbar-brand primary-color" href="index.html">
                <img src=/images/neetgurumantra-logo-org.png" alt="NEET Gurumantra"/>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleContainer">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown02">
                            <a class="dropdown-item primary-color" href="#">NEET</a>
                            <a class="dropdown-item primary-color" href="#">AIIMS</a>
                            <a class="dropdown-item primary-color" href="#">JIPMER</a>
                            <a class="dropdown-item primary-color" href="#">EAMCET</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                ...
                <div class="form-inline my-2 my-md-0 pull-sm-left">
                    <a class="grey-color mr-2 primary-color" href="">Log In</a>
                    <a class="grey-color primary-color" href="">Sign Up</a>
                </div>
            </div>
        </div>
    </nav>
      ...
      <h1 class="secondary-color display-4 mb-4">Book a guidence session by NEET/AIIMS Topper</h1>
        ...
        <div class="row grey-color">
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 mb-4">
                <div class="card">
                  <img class="card-img-top img-fluid" src=/images/expert1.png" alt="Card image cap">
                  <div class="card-block">
