        ...
        <div class="sidebar-inner">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="tm nav-parent nav-active">
                <a href="#"><i class="icon-puzzle"></i><span>Physics</span> <span class="fa arrow"></span></a>
                <ul class="children collapse">
                   <li><a href="{{ URL::to('home/1/11') }}">11th</a></li>
                   <li><a href="{{ URL::to('home/1/12') }}">12th</a></li>
                </ul>
            </li>
            <li class="tm nav-parent nav-active">
              <a href="#"><i class="icon-puzzle"></i><span>Chemistry</span> <span class="fa arrow"></span></a>
              <ul class="children collapse">
                   <li><a href="{{ URL::to('home/2/11') }}">11th</a></li>
                   <li><a href="{{ URL::to('home/2/12') }}">12th</a></li>
                </ul>
            </li>
            <li class="tm nav-parent nav-active">
            ...
            <ul class="header-menu nav navbar-nav">
              ...
              <li class="dropdown" id="user-header">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li>
                    <a href="{{ URL::to('logout') }}"></i><span>Logout</span></a>
                  </li>
                </ul>
              </li>
              <!-- END USER DROPDOWN -->
