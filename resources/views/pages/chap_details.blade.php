            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <div class="collection waves-color-demo">
                  ...
                  <div class="collection-item" style="font-size: 20px;">A-R Questions ({{$data['ar']}}/{{$data['allques']}})<a href="{{URL::to('qpage')}}/{{ $sub_id }}/{{ $chap_id }}/imp" class="waves-effect waves-light btn secondary-content" style="font-size: 15px;margin-right:7px;margin-top: 10px;">Start</a></div>

                  <div class="collection-item" style="font-size: 20px;">Unattempted ({{$data['unattempt']}}/{{$data['allques']}})<a href="{{URL::to('qpage')}}/{{ $sub_id }}/{{ $chap_id }}/imp" class="waves-effect waves-light btn secondary-content" style="font-size: 15px;margin-right:7px;margin-top: 10px;">Start</a></div>


                  <div class="collection-item" style="font-size: 20px;">Correct ({{$data['correct']}}/{{$data['attempt']}})<a href="{{URL::to('qpage')}}/{{ $sub_id }}/{{ $chap_id }}/imp" class="waves-effect waves-light btn secondary-content" style="font-size: 15px;;margin-right:12px;margin-top: 10px;">View</a></div>

                  <div class="collection-item" style="font-size: 20px;">Incorrect ({{$data['incorrect']}}/{{$data['attempt']}})<a href="{{URL::to('qpage')}}/{{ $sub_id }}/{{ $chap_id }}/imp" class="waves-effect waves-light btn secondary-content" style="font-size: 15px;margin-right:12px;margin-top: 10px;">View</a></div>
