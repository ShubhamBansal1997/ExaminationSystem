            ...
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <div class="collection waves-color-demo">
                  ...
                  <div class="collection-item" style="font-size: 20px; text-align: center"><a href="{{URL::to('qpage')}}/{{ $sub_id }}/{{ $chap_id }}/imp" class="waves-effect waves-light btn secondary-content" style="font-size: 15px;margin-right: 25px;margin-top: 18px">Attempt The Whole Chapter Again</a></div>
