          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><div style="margin-bottom: 10px; text-align: center;">@if($sub_id==1) {{ "Physics" }} @elseif($sub_id==2) {{ "Chemistry" }} @else {{ "Biology" }} @endif - {{ $std }}th</div></h5>
