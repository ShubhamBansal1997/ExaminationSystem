          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title" style="font-size: 40px; margin-bottom: 12px"><center>2 Year Advanced Packages</center></h5>
                ...
                <article class="col s12 m6 l4">
                  <div class="card hoverable">
                    <div class="card-image purple waves-effect">
                      ...
                      <div class="price"><sup>₹</sup>1000<sub></sub></div>
                ...
                <article class="col s12 m6 l4">
                  <div class="card z-depth-1">
                    <div class="card-image light-blue waves-effect">
                      <!-- <div class="card-title">BASIC</div> -->
                      <div class="price"><sup>₹</sup>1100<sub></sub></div>
                      <div class="price-desc">2 years</div>
                    </div>
                    <div class="card-content">
                      <ul class="collection">
              ...
              <section class="plans-container" id="plans">
                <article class="col s12 m6 l4">
                  <div class="card z-depth-1">
                    <div class="card-image purple waves-effect">
                      <!-- <div class="card-title">BASIC</div> -->
                      <div class="price"><sup>₹</sup>1200<sub></sub></div>
                      <div class="price-desc">2 years</div>
                    </div>
                    <div class="card-content">
                      <ul class="collection">
