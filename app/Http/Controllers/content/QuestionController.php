...
class QuestionController extends Controller
{
    ...
    {
    	return view('content.addeditquestion',compact('sub_id','std'));
    }
    public function addquestion(Request $request)
    {
    	...
    	if($request->ques_id==NULL)
        {
          ...
          $question->ques_ar = $request->ques_ar;
             $question->email =  Session::get('cemail');
        	$question->save();
    ...
    {
    	return view('content.view_ques',compact('sub_id','std'));
    }
    ...
    public function viewquestionlist(Request $request)
    {
        ...
        $std=$request->std;
        return view('content.viewquestion',compact('questions','sub_id','std'));
    }
    ...
    public function editquestion($ques_id,$sub_id,$std)
    {
        ...
        return view('content.addeditquestion',compact('sub_id','std','question','chap_id','chap_name'));
    }
    public function deletequestion($ques_id,$sub_id,$std)
    {
        ...
        $route = 'content/viewques/'. $sub_id . '/' . $std;
    ...
    {
        $question = Questions::where('ques_id',$ques_id)->first();
        return view('content.qpage',compact('question'));
    }
    public function view_look1($ques_id)
    {
        $question = Questions::where('ques_id',$ques_id)->first();
        return view('content.qpage1',compact('question'));
    }public function view_look2($ques_id)
    {
        $question = Questions::where('ques_id',$ques_id)->first();
        return view('content.qpage2',compact('question'));
    }
    ...
    public function addneetseries()
    {
        ...
        return view('content.addneetques');
    ...
    public function addaiimsseries()
    {
        ...
        return view('content.addaiimsques');
    ...
    public function addeamcetseries()
    {
        ...
        return view('content.addeamcetques');
...
return Redirect::back();
    ...
    public function view_ques_test($id)
    {
        ...
        return view('content.view_ques_test',compact('id'));
    }
...
return view('content.view_ques_test_series',compact('id','data'));
    }

  public function editquestiontest($ques_id)
    {
        $question = Testseriesquestion::where('id',$ques_id)->first();
        return view('content.addeditquestiontest',compact('question'));
    }
